...
- `backend/`: This directory contains the backend code for the Amharic Text to Speech, including the API endpoints, database models, and Libraries implemented in Python using the Flask framework.
